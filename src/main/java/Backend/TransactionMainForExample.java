...
public class TransactionMainForExample {
    public static void main(String[] args) {
        ...
        // 获取已加载的数据
        Map<String, Transaction_FZ> dataMap = loader.getTransactionData();

        // === 2. 调取交易（按 ID） ===
        String id = "250404001"; // 示例 ID
        Transaction_FZ t1 = dataMap.get(id);
        if (t1 != null) {
        ...
        // === 3. 比较交易 ===
        // 自定义创建一个交易对象
        Transaction_FZ t2 = new Transaction_FZ("250404001", LocalDate.of(2025, 4, 4), "Amazon", "Book", "Expense", 239.90);
